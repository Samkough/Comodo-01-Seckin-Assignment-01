...
cur.execute('''CREATE TABLE IF NOT EXISTS utterances
            (Time INTEGER, Duration INTEGER, SrcDevice TEXT, DstDevice TEXT, Protocol INTEGER, SrcPort INTEGER, DstPort INTEGER, SrcPackets INTEGER, DstPackets INTEGER, SrcBytes INTEGER, DstBytes INTEGER)''') # create the table if it doesn't already exist
